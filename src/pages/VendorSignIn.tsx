...
const VendorSignIn = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        } else if (!vendor?.subscription_plan) {
      ...
      if (existingUser && existingUser.role !== 'vendor') {
        toast.error('This email is not registered as a vendor account');
        return;
      }
  ...
  const handleRegisterClick = () => {
    console.log('Register here clicked → Navigating to /get-started with vendor role');
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="mt-4 space-y-4 text-center">
          ...
          <p className="text-sm text-gray-600">
            ...
            <button
              onClick={handleRegisterClick} // Updated handler
