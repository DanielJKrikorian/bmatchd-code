-- Create function to send notification email through Edge Function
...
COMMENT ON FUNCTION send_notification_email IS 'Sends email notifications through Edge Function when new notifications are created';