-- Drop and recreate subscription_plans table with correct schema
...
INSERT INTO subscription_plans (stripe_price_id, plan_name, plan_type, billing_interval) VALUES
  ('price_1QkEtxAkjdPARDjPWEOOGAon', 'Essential Monthly', 'essential', 'month'),
